...
var onShowAllPets = function onShowAllPets(event) {
  event.preventDefault();
  api.showPets().then(ui.showPetsSuccess).catch(ui.showPetsFailure);
};

var onShowAPet = function onShowAPet(event) {
  // console.log(event.target)
  event.preventDefault();
  var data = getFormFields(event.target);
  // console.log(data)
  api.showPet(data).then(ui.showPetSuccess).catch(ui.showPetFailure);
  $('#view-pet-button').trigger('reset');
  $('input').prop('required', true);
};

var onDeletePet = function onDeletePet(event) {
  event.preventDefault();
  // console.log(event.target)
  var data = getFormFields(event.target);
  api.deletePet(data).then(ui.deletePetSuccess).catch(ui.deletePetFailure);
...
var onUpdatePet = function onUpdatePet(event) {
  ...
  api.updatePet(data).then(ui.updatePetSuccess).catch(ui.updatePetFailure);
  $('#update-button').trigger('reset');
  $('#content').html('');
  $('input').prop('required', true);
};

var onCreateOwner = function onCreateOwner(event) {
  var data = getFormFields(event.target);
  event.preventDefault();
  api.createOwner(data).then(ui.createOwnerSuccess).catch(ui.createOwnerFailure);
  $('#create-owner-button').trigger('reset');
  $('#content').html('');
  $('input').prop('required', true);
};

var onShowAllOwners = function onShowAllOwners(event) {
  event.preventDefault();
  api.showOwners().then(ui.showOwnersSuccess).catch(ui.showOwnersFailure);
};

var onShowAOwner = function onShowAOwner(event) {
  // console.log(event.target)
  event.preventDefault();
  var data = getFormFields(event.target);
  // console.log(data)
  api.showOwner(data).then(ui.showOwnerSuccess).catch(ui.showOwnerFailure);
  $('#view-owner-button').trigger('reset');
  $('input').prop('required', true);
};

var onDeleteOwner = function onDeleteOwner(event) {
  event.preventDefault();
  // console.log(event.target)
  var data = getFormFields(event.target);
  // console.log(data)
  api.deleteOwner(data).then(ui.deleteOwnerSuccess).catch(ui.deleteOwnerFailure);
  $('#destroy-owner-button').trigger('reset');
  $('#content').html('');
  $('input').prop('required', true);
};

var onUpdateOwner = function onUpdateOwner(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.updateOwner(data).then(ui.updateOwnerSuccess).catch(ui.updateOwnerFailure);
  $('#update-owner-button').trigger('reset');
  $('#content').html('');
  $('input').prop('required', true);
};

var onShowPetsByOwner = function onShowPetsByOwner(event) {
  // console.log(event.target)
  event.preventDefault();
  var data = getFormFields(event.target);
  // console.log(data)
  api.showPetsByOwner(data).then(ui.showPetsByOwnerSuccess).catch(ui.showPetsByOwnerFailure);
...
var addHandlers = function addHandlers() {
  ...
  $('#newOwnerButton').on('click', function () {
    $('#create-owner-error').text('');
  });
  $('#viewOneOwnerButton').on('click', function () {
    $('#view-owner-error').text('');
  });
  $('#updateOwnerButton').on('click', function () {
    $('#update-owner-error').text('');
  });
  $('#destroyOwnerButton').on('click', function () {
    $('#destroy-owner-error').text('');
  });
  $('#newPetButton').on('click', function () {
    $('#create-error').text('');
  });
  $('#viewOnePetButton').on('click', function () {
    $('#view-pet-error').text('');
  });
  $('#viewPetsByOwnerButton').on('click', function () {
    $('#view-pets-by-owner-error').text('');
  });
  $('#updatePetButton').on('click', function () {
    $('#update-error').text('');
  });
  $('#destroyPetButton').on('click', function () {
    $('#destroy-pet-error').text('');
  });
};
...
var petsTemplate = __webpack_require__(16);
var store = __webpack_require__(7);
var petTemplate = __webpack_require__(33);
var ownerTemplate = __webpack_require__(34);
var ownersTemplate = __webpack_require__(35);
var showPetsByOwnerTemplate = __webpack_require__(36);
...
var createPetSuccess = function createPetSuccess(data) {
  var petHtml = petTemplate({ pet: data.pet });
...
var showPetsSuccess = function showPetsSuccess(data) {
  if (data.pets.length === 0) {
    ...
    var petHtml = petsTemplate({ pets: data.pets });
    $('#content').html('');
    $('#content').html(petHtml);
  }
};

var showPetsFailure = function showPetsFailure() {
  $('#view-pet-error').text('Error showing pets').css('color', 'red');
  $('#message').html('');
};

var deletePetSuccess = function deletePetSuccess(id) {
...
var showPetSuccess = function showPetSuccess(data) {
  var petHtml = petTemplate({ pet: data.pet });
  $('#show-pet').modal('hide');
  $('#content').html(petHtml);
...
var showPetFailure = function showPetFailure() {
  $('#view-pet-error').text('Error retrieving record').css('color', 'red');
  $('#message').html('');
};

var createOwnerSuccess = function createOwnerSuccess(data) {
  var ownerHtml = ownerTemplate({ owner: data.owner });
  $('#message').text('Owner successfully created!').css('color', 'green');
  $('#create-owner').modal('hide');
  $('#content').html(ownerHtml);
};

var createOwnerFailure = function createOwnerFailure() {
  $('#create-owner-error').text('Error creating owner').css('color', 'red');
  $('#message').html('');
};

var showOwnersSuccess = function showOwnersSuccess(data) {
  if (data.owners.length === 0) {
    $('#message').text('No Records Available').css('color', 'red');
  } else {
    $('#message').text('Successfully retrieved owner records!').css('color', 'green');
    var ownerHtml = ownersTemplate({ owners: data.owners });
    $('#content').html('');
    $('#content').html(ownerHtml);
  }
};

var showOwnersFailure = function showOwnersFailure() {
  $('#message').text('Error showing owners').css('color', 'red');
};

var deleteOwnerSuccess = function deleteOwnerSuccess(data) {
  $('#destroy-owner').modal('hide');
  $('#message').text('Successfully deleted owner!').css('color', 'green');
  $('#content').html('');
};

var deleteOwnerFailure = function deleteOwnerFailure() {
  $('#destroy-owner-error').text('Error deleting owner').css('color', 'red');
  $('#message').html('');
};

var updateOwnerSuccess = function updateOwnerSuccess(data) {
...
var updateOwnerFailure = function updateOwnerFailure() {
  $('#update-owner-error').text('Error updating owner').css('color', 'red');
  $('#message').html('');
};

var showOwnerSuccess = function showOwnerSuccess(data) {
  var ownerHtml = ownerTemplate({ owner: data.owner });
...
var showOwnerFailure = function showOwnerFailure() {
  $('#view-owner-error').text('Error retrieving record').css('color', 'red');
  $('#message').html('');
};

var showPetsByOwnerSuccess = function showPetsByOwnerSuccess(data) {
  $('#message').text('Successfully retrieved pet records!').css('color', 'green');
  var petHtml = showPetsByOwnerTemplate({ owner: data.owner, pets: data.owner.pets });
  $('#show-pets-by-owner').modal('hide');
  $('#content').html('');
  $('#content').html(petHtml);
};

var showPetsByOwnerFailure = function showPetsByOwnerFailure() {
...
module.exports = {
  ...
  showPetsFailure: showPetsFailure,
  ...
  showPetSuccess: showPetSuccess,
  showPetFailure: showPetFailure,
  createOwnerSuccess: createOwnerSuccess,
  createOwnerFailure: createOwnerFailure,
  showOwnersSuccess: showOwnersSuccess,
  showOwnersFailure: showOwnersFailure,
  deleteOwnerSuccess: deleteOwnerSuccess,
  deleteOwnerFailure: deleteOwnerFailure,
  updateOwnerSuccess: updateOwnerSuccess,
  updateOwnerFailure: updateOwnerFailure,
  showOwnerSuccess: showOwnerSuccess,
  showOwnerFailure: showOwnerFailure,
  showPetsByOwnerSuccess: showPetsByOwnerSuccess,
  showPetsByOwnerFailure: showPetsByOwnerFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n<!-- template to display pet -->\n<div class=\"pets-content\" data-id=\""
    ...
    + "</h5>\n"
    + ((stack1 = helpers.blockHelperMissing.call(depth0,alias1(((stack1 = blockParams[0][0]) != null ? stack1.owner : stack1), depth0),{"name":"pet.owner","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "  <br>\n</div>\n\n";
},"2":function(container,depth0,helpers,partials,data) {
    var helper, alias1=depth0 != null ? depth0 : (container.nullContext || {}), alias2=helpers.helperMissing, alias3="function", alias4=container.escapeExpression;

  return "    <h5><strong>Owner ID:</strong> "
    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
    + "</h5>\n    <h5><strong>Owner:</strong> "
    + alias4(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"name","hash":{},"data":data}) : helper)))
    + "</h5>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.pets : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"pets-content\" data-id=\""
    ...
    + "</h5>\n  <h5><strong>Pet ID:</strong> "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.pet : depth0)) != null ? stack1.id : stack1), depth0))
    + "</h5>\n  <h5><strong>Species:</strong> "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.pet : depth0)) != null ? stack1.species : stack1), depth0))
    + "</h5>\n  <h5><strong>Age:</strong> "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.pet : depth0)) != null ? stack1.age : stack1), depth0))
    + "</h5>\n  <h5><strong>Gender:</strong> "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.pet : depth0)) != null ? stack1.gender : stack1), depth0))
    + "</h5>\n  <h5><strong>Color:</strong> "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.pet : depth0)) != null ? stack1.color : stack1), depth0))
    + "</h5>\n"
    + ((stack1 = helpers.blockHelperMissing.call(depth0,alias1(((stack1 = (depth0 != null ? depth0.pet : depth0)) != null ? stack1.owner : stack1), depth0),{"name":"pet.owner","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "</div>\n";
},"2":function(container,depth0,helpers,partials,data) {
    var helper, alias1=depth0 != null ? depth0 : (container.nullContext || {}), alias2=helpers.helperMissing, alias3="function", alias4=container.escapeExpression;
  ...
  return "    <h5><strong>Owner ID:</strong> "
    ...
    return "  <h5><strong>No Records</strong></h5>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1;

  return "<!-- template to display pet -->\n\n"
    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = (depth0 != null ? depth0.pet : depth0)) != null ? stack1.id : stack1),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(4, data, 0),"data":data})) != null ? stack1 : "");
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<!-- template to display owners -->\n<div class=\"owners-content\" data-id=\""
    ...
    + "</h4>\n  <h5><strong>ID:</strong> "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.owner : depth0)) != null ? stack1.id : stack1), depth0))
    + "</h5>\n  <h5><strong>Phone Number:</strong> "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.owner : depth0)) != null ? stack1.phone_number : stack1), depth0))
    + "</h5>\n  <br>\n</div>\n";
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<div class=\"owners-content\" data-id=\""
    ...
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
    + "</h5>\n    <h5><strong>Phone Number:</strong> "
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.phone_number : stack1), depth0))
    + "</h5>\n    <br>\n</div>\n";
},"4":function(container,depth0,helpers,partials,data) {
    return "  <h5><strong>No Records</strong></h5>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.owners : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"useData":true,"useBlockParams":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "  <!-- template to display pet -->\n  <div class=\"pets-content\" data-id=\""
    ...
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
    + "</h5>\n    <h5><strong>Species:</strong> "
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.species : stack1), depth0))
    + "</h5>\n    <h5><strong>Age:</strong> "
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.age : stack1), depth0))
    + "</h5>\n    <h5><strong>Gender:</strong> "
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.gender : stack1), depth0))
    + "</h5>\n    <h5><strong>Color:</strong> "
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.color : stack1), depth0))
    + "</h5>\n    <br>\n  </div>\n";
},"4":function(container,depth0,helpers,partials,data) {
    return "    <h5><strong>No Pet Records</strong></h5>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1, alias1=container.lambda, alias2=container.escapeExpression;
...
var showPet = function showPet(data) {
  // console.log(data)
  return $.ajax({
...
var createOwner = function createOwner(data) {
  return $.ajax({
...
var showOwners = function showOwners() {
  return $.ajax({
    url: config.apiOrigin + '/owners',
    method: 'GET',
    headers: {
...
var showOwner = function showOwner(data) {
  // console.log(data)
  return $.ajax({
...
var deleteOwner = function deleteOwner(data) {
...
var updateOwner = function updateOwner(data) {
  return $.ajax({
    url: config.apiOrigin + '/owners/' + data.owner.id,
    method: 'PATCH',
    headers: {
...
var showPetsByOwner = function showPetsByOwner(data) {
  return $.ajax({
    url: config.apiOrigin + '/owners/' + data.owner.id,
    method: 'GET',
    headers: {
...
module.exports = {
  ...
  showOwner: showOwner,
  showPetsByOwner: showPetsByOwner
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
